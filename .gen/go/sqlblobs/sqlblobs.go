...
type DomainInfo struct {
	...
	ActiveClusters                       *shared.ActiveClusters `json:"activeClusters,omitempty"`
...
func _ActiveClusters_Read(w wire.Value) (*shared.ActiveClusters, error) {
	var v shared.ActiveClusters
	err := v.FromWire(w)
	return &v, err
}
...
func _ActiveClusters_Decode(sr stream.Reader) (*shared.ActiveClusters, error) {
	var v shared.ActiveClusters
	err := v.Decode(sr)
	return &v, err
}
...
// zero value if it is unset.
func (v *DomainInfo) GetActiveClusters() (o *shared.ActiveClusters) {
...
func (v *DomainInfo) IsSetActiveClusters() bool {
...
var ThriftModule = &thriftreflect.ThriftModule{
	...
	SHA1:     "298e52e873984337961de1031b9e7ea6a1c5c201",
